...
function serverSideArrayTypeProduct($request){
    $output = array('0' => 'N', '1' => 'Y');

    $strSQL = 'SELECT type_product FROM product WHERE idproduct=%d';
...
}else if($_GET['request_data'] == 'type_product'){
    $returnArray = serverSideArrayTypeProduct($_GET);
}
header('Access-Control-Allow-Origin: *');
