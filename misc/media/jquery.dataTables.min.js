...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Show _MENU_ entries",sZeroRecords:"No matching records found",sInfo:"Showing _START_ to _END_ of _TOTAL_ entries",sInfoEmpty:"<span style=\"font-size: 10pt;\">Showing 0 to 0 of 0 entries</span>",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"}};
...
this._iDisplayLength=100;this._iDisplayStart=0;this._iDisplayEnd=10;this._iRecordsTotal=0;
...
i<iLen;i++){n[i].innerHTML=sInfo}}}function _fnFeatureHtmlLength(oSettings){var sName=(oSettings.sTableId==="")?"":'name="'+oSettings.sTableId+'_length"';var pilihan_id = (oSettings.sTableId === "") ? "" : 'id="'+oSettings.sTableId+'_id"';
var sStdMenu='<select size="1" '+sName+' '+pilihan_id+'><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select>';
