  ...
  if (isset($_GET['pesan'])){
	...
	drupal_add_js('
		...
		$(document).ready(function(){
			...
			oTable = $("#tabel_karyawan_baru").dataTable( {
				"bJQueryUI": true,
				"bPaginate": false,
				"bLengthChange": false,
				"bFilter": true,
			...
			$("#select_all").click(function(){
				$(".approve-karyawan-baru").attr("checked","checked");
			});
			$("#deselect_all").click(function(){
				$(".approve-karyawan-baru").removeAttr("checked");
			});
			$("#do_approve_karyawan").click(function(){
				...
				submitaddress = Drupal.settings.basePath + "hrd/doapprovekaryawanbaru";
				$.ajax({ 
					type: "POST",
					url: submitaddress,
					data: request, 
					...
					success: function(data){
						...
						window.location = Drupal.settings.basePath + "hrd/approvekaryawanbaru?pesan=Approve karyawan berhasil";
					}
				});
			});
		})
	','inline');
	$arraymessage['title'] = t('Untuk melakukan approve karyawan baru :');
