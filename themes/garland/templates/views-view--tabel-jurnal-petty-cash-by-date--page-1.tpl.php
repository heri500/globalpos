  ...
  $(document).ready(function(){
  	$("#edit-created-max-wrapper label").html("s.d.");
   	...
   	$("#edit-created-max-wrapper label").css("margin-right","8px");
		$("#edit-submit-tabel-jurnal-petty-cash-by-date").text("Filter Data");
		$("#edit-submit-tabel-jurnal-petty-cash-by-date").css("font-size","8.4pt");
		$("#edit-submit-tabel-jurnal-petty-cash-by-date").button();
		$("#edit-submit-tabel-jurnal-petty-cash-by-date").parent().css("width","auto");
		$("#edit-submit-tabel-jurnal-petty-cash-by-date").css("margin-top","0");
		...
		$("#views-exposed-form-tabel-jurnal-petty-cash-by-date-page-1").prepend($("#pilihancabang"));
		$("#views-exposed-form-tabel-jurnal-petty-cash-by-date-page-1").css("margin-bottom","0");
		oTable = $("#tabel-petty-cash").dataTable( {
			"bJQueryUI": true,
			"bPaginate": false,
			"bFilter": true,
			"bInfo": true,
