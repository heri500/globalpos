 ...
 */
 ...
 print $div_bulan_selection;
?>
<table id="tabel-payroll" title="Tabel Payroll" class="easyui-datagrid" data-options="singleSelect:true" style="width: 950px;height:320px;">
  <?php if (!empty($title)) : ?>
  ...
  <thead data-options="frozen:true">
    <tr>
    	<?php
    	$lebarkolom = array(80,220,150,120,100);
    	$lebarkolomabsen = 40;
    	$i = 0;
    	?>
  ...
  <tbody>
    ...
    <?php
    	...
    	if (count($array_hadir_karyawan) > 0){
    		if ($view->result[$count]->node_data_field_nik_field_departemen_nid != 97180){
    ?>
