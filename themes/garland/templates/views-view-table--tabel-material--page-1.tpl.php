 ...
 */
 ...
 ','inline');
	...
	$superuser = false;
 	...
 	if ($superuser){
 		$alamat_tambah_material = base_path().'node/add/data-material';	
 	}
 	if ((arg(2) <> $id_posisi_user) AND !$superuser){
 		drupal_goto('inventory');
 	}
?>
<button onclick="goto_address('<?php print $alamat_tambah_material; ?>')" class="add_data">TAMBAH MATERIAL</button>
