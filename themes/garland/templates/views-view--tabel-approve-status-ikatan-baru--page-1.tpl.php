 ...
 if (isset($_GET['pesan'])){
	...
	drupal_add_js('
		...
		$(document).ready(function(){
			...
			oTable = $("#tabel_ikatan_baru").dataTable( {
				"bJQueryUI": true,
				"bPaginate": false,
				"bLengthChange": false,
				"bFilter": true,
			...
			$("#select_all").click(function(){
				$(".approve-ikatan-baru").attr("checked","checked");
			});
			$("#deselect_all").click(function(){
				$(".approve-ikatan-baru").removeAttr("checked");
			});
			$("#do_approve_status").click(function(){
				...
				submitaddress = Drupal.settings.basePath + "hrd/doapprovestatusbaru";
				$.ajax({ 
					type: "POST",
					url: submitaddress,
					data: request, 
					...
					success: function(data){
						...
						window.location = Drupal.settings.basePath + "hrd/approvestatusikatankerja?pesan=Approve status ikatan kerja karyawan berhasil";
					}
				});
			});
		})
	','inline');
	$arraymessage['title'] = t('Untuk melakukan approve status ikatan kerja :');
