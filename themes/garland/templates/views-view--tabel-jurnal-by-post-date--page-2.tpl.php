	...
	drupal_add_js('
	  var pathutama = Drupal.settings.basePath;
		function edit_jurnal(nid_jurnal_ref){
			window.location = pathutama + "akutansi/editjurnal?jurnal_nid="+ nid_jurnal_ref +"&cabang="+ $("#cabang").val() +"&created_min="+ $("#edit-created-min").val() +"&created_max="+ $("#edit-created-max").val();
		}
		$(document).ready(function(){
   		...
   		TableToolsInit.sSwfPath = pathutama + "misc/media/datatables/swf/ZeroClipboard.swf";
			...
			$("#views-exposed-form-tabel-jurnal-by-post-date-page-2").prepend($("#pilihancabang"));
   		$("#filtertabel").button();
   		$("#edit-submit-tabel-jurnal-by-post-date").parent().css("width","auto");
   		$("#edit-submit-tabel-jurnal-by-post-date").css("margin-top","3px");
   		$("#edit-field-account-ref-nid").css("width","120px");
   		var combo_left_margin_value = -1;
   		var combo_top_value = 3;
   		$("#edit-field-account-ref-nid").combobox();
   		console.log($("#tombolcomboauto").attr("id"));
   		$("#edit-field-account-ref-nid").parent().parent().parent().css("width","280px");
   		$("#edit-uid").css("width","150px");
   		$("#edit-uid").parent().parent().parent().css("width","280px");
   		$("#edit-uid-wrapper div.description").hide();
   		$("#edit-title").css("width","150px");
   		$("#edit-title").parent().parent().parent().css("width","280px");
   	})
	','inline');
	global $user;
	$superuser = false;
