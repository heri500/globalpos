...
?>
<table id="tabeldepartemen" class="<?php print $class; ?> display">
  <?php if (!empty($title)) : ?>
      ...
      <tr class="<?php print implode(' ', $row_classes[$count]); ?>">
        <?php foreach ($row as $field => $content): ?>
          ...
          <?php
	      		...
	      		$image_to_edit = '<img src="'.base_path().'misc/media/images/edit.ico" width="20" onclick="edit_departemen(\''.$nid_departemen.'\')">';
	        ?>
	        <td class="views-field views-field-<?php print $fields[$field]; ?>">
