	...
	function see_details(nTr,iconbutton,nid){
 	...
 	$(document).ready(function(){
   	...
   	$("#edit-created-max-wrapper label").css("margin-right","8px");
		$("#edit-submit-tabel-penerimaan-material").text("Filter Data");
		$("#edit-submit-tabel-penerimaan-material").css("font-size","8.4pt");
		$("#edit-submit-tabel-penerimaan-material").button();
		$("#edit-submit-tabel-penerimaan-material").parent().css("width","auto");
		$("#edit-submit-tabel-penerimaan-material").css("margin-top","0");
	 	oTable = $("#tabel_penerimaan_material").dataTable( {
			"bJQueryUI": true,
			"bPaginate": true,
			"bLengthChange": true,
			"bFilter": true,
		...
		$("#views-exposed-form-tabel-penerimaan-material-page-1").prepend($("#pilihancabang"));
		$("#views-exposed-form-tabel-penerimaan-material-page-1").css("margin-bottom","0");
		$("button").button();
	})
 ','inline');
 global $user;
